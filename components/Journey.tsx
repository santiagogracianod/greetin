...
export default function Journey() {
  ...
  return <main className={`journey step-${step}`}>
    ...
    <div className="screen">
      ...
      {step === 1 && <section className="section-inner story"><Sun className="dawn-sun" /><WaveLines /><SectionEyebrow>EL MAPA</SectionEyebrow><div className="title-row"><h2>Donde todo<br /><em>comenzó.</em></h2><p>Hay momentos que parecen pequeños cuando suceden, pero con el tiempo descubrimos que estaban marcando el inicio de algo.</p></div><div className="timeline"><div className="timeline-line" /><article><span className="timeline-date">FECHA / 01</span><div><h3>El primer encuentro</h3><p>Escribe aquí cómo se conocieron, qué pensaste ese día o ese detalle que nunca olvidaste.</p></div><MediaPlaceholder type="photo" label="Foto del comienzo" /></article><article><span className="timeline-date">FECHA / 02</span><div><h3>Ese momento</h3><p>Un recuerdo que todavía te hace sonreír. Puede ser una salida, una conversación o una coincidencia.</p></div><MediaPlaceholder type="video" label="Video del recuerdo" /></article></div></section>}
      {step === 2 && <section className="section-inner beautiful"><Sun className="field-sun" /><div className="sunflower-field"><Sunflower delay={0} /><Sunflower delay={.4} /><Sunflower delay={.8} /><Sunflower delay={.2} /></div><Drift count={10} tone="gold" /><SectionEyebrow>LOS DÍAS BONITOS</SectionEyebrow><h2>Lo que todavía<br /><em>florece.</em></h2><p className="intro">Aquí van las cosas que hicieron que valiera la pena: los bailes, las risas sin sentido y esos instantes que se sintieron como casa.</p><div className="memory-grid"><MediaPlaceholder label="Una foto que nos representa" /><MediaPlaceholder type="video" label="Nuestro baile" className="tall" /><MediaPlaceholder label="Un día favorito" /></div></section>}
